...
- `nodes` (Attributes List) Gateway nodes that form the HA cluster (see [below for nested schema](#nestedatt--nodes))
- `site_id` (String)
...
- `mac` (String) Gateway device MAC address. Format is `[0-9a-f]{12}` (e.g. "5684dae9ac8b")
