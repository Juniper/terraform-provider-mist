...
subcategory: "Devices"
description: |-
  This resource manages the AP Device Profiles.An AP Device Profile can be used to define common configuration accross multiple Wireless Access Pointsand is assigned to one or multiple APs as a deviceprofile with the mist_org_deviceprofile_assign resource
---
