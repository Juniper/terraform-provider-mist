...
- `name` (String) Display name of the gateway profile
- `org_id` (String) Organization that owns this gateway profile

### Optional

- `additional_config_cmds` (List of String) Additional CLI configuration commands provided by this gateway profile
- `bgp_config` (Attributes Map) BGP routing defaults for this gateway profile. Property key is the BGP session name (see [below for nested schema](#nestedatt--bgp_config))
- `dhcpd_config` (Attributes) DHCP server defaults provided by this gateway profile (see [below for nested schema](#nestedatt--dhcpd_config))
- `dns_override` (Boolean) Whether DNS server and suffix settings in this profile override inherited values
- `dns_servers` (List of String) DNS servers provided by this gateway profile
- `dns_suffix` (List of String) DNS search suffixes provided by this gateway profile
- `extra_routes` (Attributes Map) Additional IPv4 route defaults in this gateway profile (see [below for nested schema](#nestedatt--extra_routes))
- `extra_routes6` (Attributes Map) Additional IPv6 route defaults in this gateway profile (see [below for nested schema](#nestedatt--extra_routes6))
- `idp_profiles` (Attributes Map) Intrusion detection and prevention profile defaults in this gateway profile (see [below for nested schema](#nestedatt--idp_profiles))
...
- `networks` (Attributes List) Layer 3 networks configured by this gateway profile (see [below for nested schema](#nestedatt--networks))
- `ntp_override` (Boolean) Whether NTP servers in this profile override inherited values
- `ntp_servers` (List of String) NTP servers provided by this gateway profile
- `oob_ip_config` (Attributes) Out-of-band management IP defaults in this gateway profile (see [below for nested schema](#nestedatt--oob_ip_config))
...
- `routing_policies` (Attributes Map) Routing policy defaults applied by this gateway profile (see [below for nested schema](#nestedatt--routing_policies))
- `service_policies` (Attributes List) Traffic service policy defaults enforced by this gateway profile (see [below for nested schema](#nestedatt--service_policies))
...
- `tunnel_provider_options` (Attributes) Provider-specific tunnel options defined by this gateway profile (see [below for nested schema](#nestedatt--tunnel_provider_options))
- `url_filtering_deny_msg` (String) When a service policy denies a app_category, what message to show in user's browser
- `vrf_config` (Attributes) VRF defaults applied by this gateway profile (see [below for nested schema](#nestedatt--vrf_config))
- `vrf_instances` (Attributes Map) VRF instances configured by this gateway profile (see [below for nested schema](#nestedatt--vrf_instances))

### Read-Only

- `id` (String) Unique identifier of the gateway profile
- `type` (String) Device type discriminator for gateway profiles
