...
description: |-
  This resource managed the Org Network Templates (Switch templates).A Network template can be used to define generic switch configuration at the site level, andbe applied to one or multiple Sites. It works like a blueprint of the network of the site.
---
