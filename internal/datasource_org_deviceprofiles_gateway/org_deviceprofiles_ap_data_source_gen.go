				...
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: OrgDeviceprofilesGatewayType{
						ObjectType: types.ObjectType{
							AttrTypes: OrgDeviceprofilesGatewayValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
var _ basetypes.ObjectTypable = OrgDeviceprofilesGatewayType{}
...
func (t OrgDeviceprofilesGatewayType) Equal(o attr.Type) bool {
	other, ok := o.(OrgDeviceprofilesGatewayType)
...
func (t OrgDeviceprofilesGatewayType) String() string {
	return "OrgDeviceprofilesGatewayType"
}
...
func (t OrgDeviceprofilesGatewayType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	return OrgDeviceprofilesGatewayValue{
...
func NewOrgDeviceprofilesGatewayValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (OrgDeviceprofilesGatewayValue, diag.Diagnostics) {
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing OrgDeviceprofilesGatewayValue Attribute Value",
				"While creating a OrgDeviceprofilesGatewayValue value, a missing attribute value was detected. "+
					"A OrgDeviceprofilesGatewayValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("OrgDeviceprofilesGatewayValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid OrgDeviceprofilesGatewayValue Attribute Type",
				"While creating a OrgDeviceprofilesGatewayValue value, an invalid attribute value was detected. "+
					"A OrgDeviceprofilesGatewayValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("OrgDeviceprofilesGatewayValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("OrgDeviceprofilesGatewayValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra OrgDeviceprofilesGatewayValue Attribute Value",
				"While creating a OrgDeviceprofilesGatewayValue value, an extra attribute value was detected. "+
					"A OrgDeviceprofilesGatewayValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra OrgDeviceprofilesGatewayValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewOrgDeviceprofilesGatewayValueUnknown(), diags
	}
...
func NewOrgDeviceprofilesGatewayValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) OrgDeviceprofilesGatewayValue {
	object, diags := NewOrgDeviceprofilesGatewayValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewOrgDeviceprofilesGatewayValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}
...
func (t OrgDeviceprofilesGatewayType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewOrgDeviceprofilesGatewayValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewOrgDeviceprofilesGatewayValueUnknown(), nil
	}
	...
	return NewOrgDeviceprofilesGatewayValueMust(OrgDeviceprofilesGatewayValue{}.AttributeTypes(ctx), attributes), nil
}
...
var _ basetypes.ObjectValuable = OrgDeviceprofilesGatewayValue{}

type OrgDeviceprofilesGatewayValue struct {
...
func (v OrgDeviceprofilesGatewayValue) Equal(o attr.Value) bool {
	other, ok := o.(OrgDeviceprofilesGatewayValue)
