...
func evpnOptionsSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.EvpnOptions) basetypes.ObjectValue {
	...
	data, e := basetypes.NewObjectValue(EvpnOptionsValue{}.AttributeTypes(ctx), data_map_value)
	diags.Append(e...)
