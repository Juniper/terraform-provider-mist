...
func SdkToTerraform(ctx context.Context, l []models.RfTemplate) (basetypes.SetValue, diag.Diagnostics) {
	...
	dataSet, err := types.SetValue(OrgRftemplatesValue{}.Type(ctx), elements)
	if err != nil {
		diags.Append(err...)
	}
