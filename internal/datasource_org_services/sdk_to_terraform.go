...
func SdkToTerraform(ctx context.Context, l []models.Service) (basetypes.SetValue, diag.Diagnostics) {
	...
	dataSet, err := types.SetValue(OrgServicesValue{}.Type(ctx), elements)
	if err != nil {
		diags.Append(err...)
	}
