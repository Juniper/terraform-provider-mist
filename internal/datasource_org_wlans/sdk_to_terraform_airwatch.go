...
func airwatchSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.WlanAirwatch) basetypes.ObjectValue {
	...
	data, e := basetypes.NewObjectValue(AirwatchValue{}.AttributeTypes(ctx), dataMapValue)
	diags.Append(e...)
