...
func bonjourSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.WlanBonjour) basetypes.ObjectValue {
	...
	if d != nil && d.AdditionalVlanIds != nil {
		additionalVlanIds = mistutils.WlanBonjourAdditionalVlanIds2AsArrayOfString(diags, *d.AdditionalVlanIds)
	}
	...
	data, e := basetypes.NewObjectValue(BonjourValue{}.AttributeTypes(ctx), dataMapValue)
	diags.Append(e...)
