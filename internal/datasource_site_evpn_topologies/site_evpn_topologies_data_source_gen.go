...
func SiteEvpnTopologiesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"site_evpn_topologies": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: SiteEvpnTopologiesType{
						ObjectType: types.ObjectType{
							AttrTypes: SiteEvpnTopologiesValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
type SiteEvpnTopologiesModel struct {
	SiteEvpnTopologies types.Set    `tfsdk:"site_evpn_topologies"`
	SiteId             types.String `tfsdk:"site_id"`
}

var _ basetypes.ObjectTypable = SiteEvpnTopologiesType{}

type SiteEvpnTopologiesType struct {
	basetypes.ObjectType
}

func (t SiteEvpnTopologiesType) Equal(o attr.Type) bool {
	other, ok := o.(SiteEvpnTopologiesType)
...
func (t SiteEvpnTopologiesType) String() string {
	return "SiteEvpnTopologiesType"
}

func (t SiteEvpnTopologiesType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	return SiteEvpnTopologiesValue{
...
func NewSiteEvpnTopologiesValueNull() SiteEvpnTopologiesValue {
	return SiteEvpnTopologiesValue{
		state: attr.ValueStateNull,
	}
}

func NewSiteEvpnTopologiesValueUnknown() SiteEvpnTopologiesValue {
	return SiteEvpnTopologiesValue{
		state: attr.ValueStateUnknown,
	}
}

func NewSiteEvpnTopologiesValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (SiteEvpnTopologiesValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing SiteEvpnTopologiesValue Attribute Value",
				"While creating a SiteEvpnTopologiesValue value, a missing attribute value was detected. "+
					"A SiteEvpnTopologiesValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("SiteEvpnTopologiesValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid SiteEvpnTopologiesValue Attribute Type",
				"While creating a SiteEvpnTopologiesValue value, an invalid attribute value was detected. "+
					"A SiteEvpnTopologiesValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("SiteEvpnTopologiesValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("SiteEvpnTopologiesValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra SiteEvpnTopologiesValue Attribute Value",
				"While creating a SiteEvpnTopologiesValue value, an extra attribute value was detected. "+
					"A SiteEvpnTopologiesValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra SiteEvpnTopologiesValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewSiteEvpnTopologiesValueUnknown(), diags
	}
...
func NewSiteEvpnTopologiesValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) SiteEvpnTopologiesValue {
	object, diags := NewSiteEvpnTopologiesValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewSiteEvpnTopologiesValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t SiteEvpnTopologiesType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewSiteEvpnTopologiesValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewSiteEvpnTopologiesValueUnknown(), nil
	}
	...
	return NewSiteEvpnTopologiesValueMust(SiteEvpnTopologiesValue{}.AttributeTypes(ctx), attributes), nil
}

func (t SiteEvpnTopologiesType) ValueType(ctx context.Context) attr.Value {
	return SiteEvpnTopologiesValue{}
}

var _ basetypes.ObjectValuable = SiteEvpnTopologiesValue{}

type SiteEvpnTopologiesValue struct {
...
func (v SiteEvpnTopologiesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v SiteEvpnTopologiesValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v SiteEvpnTopologiesValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v SiteEvpnTopologiesValue) String() string {
	return "SiteEvpnTopologiesValue"
}

func (v SiteEvpnTopologiesValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v SiteEvpnTopologiesValue) Equal(o attr.Value) bool {
	other, ok := o.(SiteEvpnTopologiesValue)
...
func (v SiteEvpnTopologiesValue) Type(ctx context.Context) attr.Type {
	return SiteEvpnTopologiesType{
		basetypes.ObjectType{
...
func (v SiteEvpnTopologiesValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
