...
func SiteWlansDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"site_id": schema.StringAttribute{
				Required: true,
			},
			"site_wlans": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
						...
						"portal": schema.SingleNestedAttribute{
							Attributes: map[string]schema.Attribute{
								...
								"auth": schema.StringAttribute{
									...
									MarkdownDescription: "authentication scheme. enum: `amazon`, `azure`, `email`, `external`, `facebook`, `google`, `microsoft`, `multi`, `none`, `password`, `sms`, `sponsor`, `sso`",
								},
					...
					CustomType: SiteWlansType{
						ObjectType: types.ObjectType{
							AttrTypes: SiteWlansValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
type SiteWlansModel struct {
	SiteId    types.String `tfsdk:"site_id"`
	SiteWlans types.Set    `tfsdk:"site_wlans"`
}

var _ basetypes.ObjectTypable = SiteWlansType{}

type SiteWlansType struct {
	basetypes.ObjectType
}

func (t SiteWlansType) Equal(o attr.Type) bool {
	other, ok := o.(SiteWlansType)
...
func (t SiteWlansType) String() string {
	return "SiteWlansType"
}

func (t SiteWlansType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
...
func NewSiteWlansValueNull() SiteWlansValue {
	return SiteWlansValue{
		state: attr.ValueStateNull,
	}
}

func NewSiteWlansValueUnknown() SiteWlansValue {
	return SiteWlansValue{
		state: attr.ValueStateUnknown,
	}
}

func NewSiteWlansValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (SiteWlansValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing SiteWlansValue Attribute Value",
				"While creating a SiteWlansValue value, a missing attribute value was detected. "+
					"A SiteWlansValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("SiteWlansValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid SiteWlansValue Attribute Type",
				"While creating a SiteWlansValue value, an invalid attribute value was detected. "+
					"A SiteWlansValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("SiteWlansValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("SiteWlansValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra SiteWlansValue Attribute Value",
				"While creating a SiteWlansValue value, an extra attribute value was detected. "+
					"A SiteWlansValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra SiteWlansValue Attribute Name: %s", name),
			)
		}
	}
...
func NewSiteWlansValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) SiteWlansValue {
	object, diags := NewSiteWlansValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewSiteWlansValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t SiteWlansType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewSiteWlansValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewSiteWlansValueUnknown(), nil
	}
	...
	return NewSiteWlansValueMust(SiteWlansValue{}.AttributeTypes(ctx), attributes), nil
}

func (t SiteWlansType) ValueType(ctx context.Context) attr.Value {
	return SiteWlansValue{}
}

var _ basetypes.ObjectValuable = SiteWlansValue{}

type SiteWlansValue struct {
...
func (v SiteWlansValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v SiteWlansValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v SiteWlansValue) String() string {
	return "SiteWlansValue"
}

func (v SiteWlansValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	var apIdsVal basetypes.ListValue
	switch {
	case v.ApIds.IsUnknown():
		apIdsVal = types.ListUnknown(types.StringType)
	case v.ApIds.IsNull():
		apIdsVal = types.ListNull(types.StringType)
	default:
	...
	var mxtunnelNameVal basetypes.ListValue
	switch {
	case v.MxtunnelName.IsUnknown():
		mxtunnelNameVal = types.ListUnknown(types.StringType)
	case v.MxtunnelName.IsNull():
		mxtunnelNameVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
	...
	var portalAllowedHostnamesVal basetypes.ListValue
	switch {
	case v.PortalAllowedHostnames.IsUnknown():
		portalAllowedHostnamesVal = types.ListUnknown(types.StringType)
	case v.PortalAllowedHostnames.IsNull():
		portalAllowedHostnamesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
	...
	var portalAllowedSubnetsVal basetypes.ListValue
	switch {
	case v.PortalAllowedSubnets.IsUnknown():
		portalAllowedSubnetsVal = types.ListUnknown(types.StringType)
	case v.PortalAllowedSubnets.IsNull():
		portalAllowedSubnetsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
	...
	var portalDeniedHostnamesVal basetypes.ListValue
	switch {
	case v.PortalDeniedHostnames.IsUnknown():
		portalDeniedHostnamesVal = types.ListUnknown(types.StringType)
	case v.PortalDeniedHostnames.IsNull():
		portalDeniedHostnamesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
	...
	var wxtagIdsVal basetypes.ListValue
	switch {
	case v.WxtagIds.IsUnknown():
		wxtagIdsVal = types.ListUnknown(types.StringType)
	case v.WxtagIds.IsNull():
		wxtagIdsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
...
func (v SiteWlansValue) Equal(o attr.Value) bool {
	other, ok := o.(SiteWlansValue)
...
func (v SiteWlansValue) Type(ctx context.Context) attr.Type {
	return SiteWlansType{
		basetypes.ObjectType{
...
func (v SiteWlansValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
