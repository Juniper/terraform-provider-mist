...
type DeviceApModel struct {
	Aeroscout        *DeviceApAeroscoutValue            `hcl:"aeroscout"`
	Airista          *DeviceApAiristaValue              `hcl:"airista"`
	BleConfig        *DeviceApBleConfigValue            `hcl:"ble_config"`
	Centrak          *DeviceApCentrakValue              `hcl:"centrak"`
	ClientBridge     *DeviceApClientBridgeValue         `hcl:"client_bridge"`
	...
	IpConfig         *DeviceApIpConfigValue             `hcl:"ip_config"`
	LacpConfig       *DeviceApLacpConfigValue           `hcl:"lacp_config"`
	Led              *DeviceApLedValue                  `hcl:"led"`
	...
	PwrConfig        *DeviceApPwrConfigValue            `hcl:"pwr_config"`
	RadioConfig      *DeviceApRadioConfigValue          `hcl:"radio_config"`
...
type DeviceApAiristaValue struct {
	Enabled *bool   `cty:"enabled" hcl:"enabled"`
	Host    *string `cty:"host" hcl:"host"`
	Port    *int64  `cty:"port" hcl:"port"`
}

type DeviceApBleConfigValue struct {
...
type DeviceApCentrakValue struct {
	Enabled *bool `cty:"enabled" hcl:"enabled"`
}

type DeviceApClientBridgeValue struct {
	Auth    *DeviceApAuthValue `cty:"auth" hcl:"auth"`
	Enabled *bool              `cty:"enabled" hcl:"enabled"`
	Ssid    *string            `cty:"ssid" hcl:"ssid"`
}

type DeviceApAuthValue struct {
	Psk      *string `cty:"psk" hcl:"psk"`
	AuthType *string `cty:"type" hcl:"type"`
}

type DeviceApEslConfigValue struct {
...
type DeviceApIpConfigValue struct {
...
type DeviceApLacpConfigValue struct {
	Enabled *bool `cty:"enabled" hcl:"enabled"`
}

type DeviceApLedValue struct {
...
type DeviceApRadioConfigValue struct {
	...
	Band5On24Radio   *DeviceApBand5On24RadioValue `cty:"band_5_on_24_radio" hcl:"band_5_on_24_radio"`
...
type DeviceApBand24Value struct {
	AllowRrmDisable *bool   `cty:"allow_rrm_disable" hcl:"allow_rrm_disable"`
...
type DeviceApUsbConfigValue struct {
	Cacert        *string `cty:"cacert" hcl:"cacert"`
	Channel       *int64  `cty:"channel" hcl:"channel"`
	Enabled       *bool   `cty:"enabled" hcl:"enabled"`
	Host          *string `cty:"host" hcl:"host"`
