...
func (d *deviceSwitchStatsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_device_switch_stats"
}

func (d *deviceSwitchStatsDataSource) Schema(ctx context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *deviceSwitchStatsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var status string
	var start string
	var mType = models.DeviceEnumWithAllEnum_ENUMSWITCH
