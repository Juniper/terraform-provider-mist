...
type OrgGatewaytemplateModel struct {
	...
	BgpConfig               map[string]OrgGatewaytemplateBgpConfigValue       `hcl:"bgp_config"`
	DhcpdConfig             *OrgGatewaytemplateDhcpdConfigValue               `hcl:"dhcpd_config"`
	DnsOverride             *bool                                             `hcl:"dns_override"`
	DnsServers              []string                                          `hcl:"dns_servers"`
	DnsSuffix               []string                                          `hcl:"dns_suffix"`
	ExtraRoutes             map[string]OrgGatewaytemplateExtraRoutesValue     `hcl:"extra_routes"`
	ExtraRoutes6            map[string]OrgGatewaytemplateExtraRoutes6Value    `hcl:"extra_routes6"`
	...
	OobIpConfig             *OrgGatewaytemplateOobIpConfigValue               `hcl:"oob_ip_config"`
	OrgId                   string                                            `hcl:"org_id"`
	PathPreferences         map[string]OrgGatewaytemplatePathPreferencesValue `hcl:"path_preferences"`
	PortConfig              map[string]OrgGatewaytemplatePortConfigValue      `hcl:"port_config"`
	RouterId                *string                                           `hcl:"router_id"`
	RoutingPolicies         map[string]OrgGatewaytemplateRoutingPoliciesValue `hcl:"routing_policies"`
	ServicePolicies         []OrgGatewaytemplateServicePoliciesValue          `hcl:"service_policies"`
	SsrAdditionalConfigCmds []string                                          `hcl:"ssr_additional_config_cmds"`
	TunnelConfigs           map[string]OrgGatewaytemplateTunnelConfigsValue   `hcl:"tunnel_configs"`
	TunnelProviderOptions   *OrgGatewaytemplateTunnelProviderOptionsValue     `hcl:"tunnel_provider_options"`
	Type                    *string                                           `hcl:"type"`
	UrlFilteringDenyMsg     *string                                           `hcl:"url_filtering_deny_msg"`
	VrfConfig               *OrgGatewaytemplateVrfConfigValue                 `hcl:"vrf_config"`
	VrfInstances            map[string]OrgGatewaytemplateVrfInstancesValue    `hcl:"vrf_instances"`
}

type OrgGatewaytemplateBgpConfigValue struct {
	...
	Neighbors              map[string]OrgGatewaytemplateNeighborsValue `cty:"neighbors" hcl:"neighbors"`
...
type OrgGatewaytemplateNeighborsValue struct {
	...
	NeighborAs   string  `cty:"neighbor_as" hcl:"neighbor_as"`
	TunnelVia    *string `cty:"tunnel_via" hcl:"tunnel_via"`
}

type OrgGatewaytemplateDhcpdConfigValue struct {
	Config  map[string]OrgGatewaytemplateConfigValue `cty:"config" hcl:"config"`
	Enabled *bool                                    `cty:"enabled" hcl:"enabled"`
}

type OrgGatewaytemplateConfigValue struct {
	DnsServers         []string                                             `cty:"dns_servers" hcl:"dns_servers"`
	DnsSuffix          []string                                             `cty:"dns_suffix" hcl:"dns_suffix"`
	FixedBindings      map[string]OrgGatewaytemplateFixedBindingsValue      `cty:"fixed_bindings" hcl:"fixed_bindings"`
	...
	Options            map[string]OrgGatewaytemplateOptionsValue            `cty:"options" hcl:"options"`
	...
	VendorEncapsulated map[string]OrgGatewaytemplateVendorEncapsulatedValue `cty:"vendor_encapsulated" hcl:"vendor_encapsulated"`
}

type OrgGatewaytemplateFixedBindingsValue struct {
	Ip   *string `cty:"ip" hcl:"ip"`
	Ip6  *string `cty:"ip6" hcl:"ip6"`
	Name *string `cty:"name" hcl:"name"`
}

type OrgGatewaytemplateOptionsValue struct {
	OptionsType *string `cty:"type" hcl:"type"`
	Value       *string `cty:"value" hcl:"value"`
}

type OrgGatewaytemplateVendorEncapsulatedValue struct {
	VendorEncapsulatedType *string `cty:"type" hcl:"type"`
	Value                  *string `cty:"value" hcl:"value"`
}

type OrgGatewaytemplateExtraRoutesValue struct {
	Via string `cty:"via" hcl:"via"`
}
...
type OrgGatewaytemplateGatewayMgmtValue struct {
	...
	AppProbing                 *OrgGatewaytemplateAppProbingValue          `cty:"app_probing" hcl:"app_probing"`
	...
	ProtectRe                  *OrgGatewaytemplateProtectReValue           `cty:"protect_re" hcl:"protect_re"`
...
type OrgGatewaytemplateAppProbingValue struct {
	Apps       []string                            `cty:"apps" hcl:"apps"`
	CustomApps []OrgGatewaytemplateCustomAppsValue `cty:"custom_apps" hcl:"custom_apps"`
	Enabled    *bool                               `cty:"enabled" hcl:"enabled"`
}

type OrgGatewaytemplateCustomAppsValue struct {
...
type OrgGatewaytemplateAutoSignatureUpdateValue struct {
...
type OrgGatewaytemplateProtectReValue struct {
	AllowedServices []string                        `cty:"allowed_services" hcl:"allowed_services"`
	Custom          []OrgGatewaytemplateCustomValue `cty:"custom" hcl:"custom"`
	Enabled         *bool                           `cty:"enabled" hcl:"enabled"`
	HitCount        *bool                           `cty:"hit_count" hcl:"hit_count"`
	TrustedHosts    []string                        `cty:"trusted_hosts" hcl:"trusted_hosts"`
}

type OrgGatewaytemplateCustomValue struct {
	PortRange *string  `cty:"port_range" hcl:"port_range"`
	Protocol  *string  `cty:"protocol" hcl:"protocol"`
	Subnets   []string `cty:"subnets" hcl:"subnets"`
}

type OrgGatewaytemplateIdpProfilesValue struct {
	BaseProfile *string                             `cty:"base_profile" hcl:"base_profile"`
	Name        *string                             `cty:"name" hcl:"name"`
	OrgId       *string                             `cty:"org_id" hcl:"org_id"`
	Overwrites  []OrgGatewaytemplateOverwritesValue `cty:"overwrites" hcl:"overwrites"`
}

type OrgGatewaytemplateOverwritesValue struct {
	Action                      *string                                             `cty:"action" hcl:"action"`
	IpdProfileOverwriteMatching *OrgGatewaytemplateIpdProfileOverwriteMatchingValue `cty:"matching" hcl:"matching"`
	Name                        *string                                             `cty:"name" hcl:"name"`
}

type OrgGatewaytemplateIpdProfileOverwriteMatchingValue struct {
...
type OrgGatewaytemplateIpConfigsValue struct {
	Ip            *string  `cty:"ip" hcl:"ip"`
	Ip6           *string  `cty:"ip6" hcl:"ip6"`
...
type OrgGatewaytemplateNetworksValue struct {
	DisallowMistServices *bool                                       `cty:"disallow_mist_services" hcl:"disallow_mist_services"`
	Gateway              *string                                     `cty:"gateway" hcl:"gateway"`
	Gateway6             *string                                     `cty:"gateway6" hcl:"gateway6"`
	InternalAccess       *OrgGatewaytemplateInternalAccessValue      `cty:"internal_access" hcl:"internal_access"`
	InternetAccess       *OrgGatewaytemplateInternetAccessValue      `cty:"internet_access" hcl:"internet_access"`
	Isolation            *bool                                       `cty:"isolation" hcl:"isolation"`
	Multicast            *OrgGatewaytemplateMulticastValue           `cty:"multicast" hcl:"multicast"`
	Name                 *string                                     `cty:"name" hcl:"name"`
...
type OrgGatewaytemplateInternetAccessValue struct {
	CreateSimpleServicePolicy    *bool                                                          `cty:"create_simple_service_policy" hcl:"create_simple_service_policy"`
	Enabled                      *bool                                                          `cty:"enabled" hcl:"enabled"`
	InternetAccessDestinationNat map[string]OrgGatewaytemplateInternetAccessDestinationNatValue `cty:"destination_nat" hcl:"destination_nat"`
	InternetAccessStaticNat      map[string]OrgGatewaytemplateInternetAccessStaticNatValue      `cty:"static_nat" hcl:"static_nat"`
	Restricted                   *bool                                                          `cty:"restricted" hcl:"restricted"`
}

type OrgGatewaytemplateInternetAccessDestinationNatValue struct {
...
type OrgGatewaytemplateInternetAccessStaticNatValue struct {
	InternalIp string  `cty:"internal_ip" hcl:"internal_ip"`
	Name       string  `cty:"name" hcl:"name"`
	WanName    *string `cty:"wan_name" hcl:"wan_name"`
}

type OrgGatewaytemplateMulticastValue struct {
	DisableIgmp *bool                                    `cty:"disable_igmp" hcl:"disable_igmp"`
	Enabled     *bool                                    `cty:"enabled" hcl:"enabled"`
	Groups      map[string]OrgGatewaytemplateGroupsValue `cty:"groups" hcl:"groups"`
}

type OrgGatewaytemplateGroupsValue struct {
	RpIp *string `cty:"rp_ip" hcl:"rp_ip"`
}

type OrgGatewaytemplateTenantsValue struct {
	Addresses []string `cty:"addresses" hcl:"addresses"`
}

type OrgGatewaytemplateVpnAccessValue struct {
	...
	SourceNat                 *OrgGatewaytemplateSourceNatValue                         `cty:"source_nat" hcl:"source_nat"`
	...
	VpnAccessDestinationNat   map[string]OrgGatewaytemplateVpnAccessDestinationNatValue `cty:"destination_nat" hcl:"destination_nat"`
	VpnAccessStaticNat        map[string]OrgGatewaytemplateVpnAccessStaticNatValue      `cty:"static_nat" hcl:"static_nat"`
}

type OrgGatewaytemplateSourceNatValue struct {
	ExternalIp *string `cty:"external_ip" hcl:"external_ip"`
}

type OrgGatewaytemplateVpnAccessDestinationNatValue struct {
	InternalIp *string `cty:"internal_ip" hcl:"internal_ip"`
	Name       *string `cty:"name" hcl:"name"`
	Port       *string `cty:"port" hcl:"port"`
}

type OrgGatewaytemplateVpnAccessStaticNatValue struct {
	InternalIp string `cty:"internal_ip" hcl:"internal_ip"`
	Name       string `cty:"name" hcl:"name"`
}

type OrgGatewaytemplateOobIpConfigValue struct {
	Gateway              *string                       `cty:"gateway" hcl:"gateway"`
	Ip                   *string                       `cty:"ip" hcl:"ip"`
	Netmask              *string                       `cty:"netmask" hcl:"netmask"`
	Node1                *OrgGatewaytemplateNode1Value `cty:"node1" hcl:"node1"`
...
type OrgGatewaytemplateNode1Value struct {
	Gateway              *string `cty:"gateway" hcl:"gateway"`
	Ip                   *string `cty:"ip" hcl:"ip"`
	Netmask              *string `cty:"netmask" hcl:"netmask"`
...
type OrgGatewaytemplatePathPreferencesValue struct {
	Paths    []OrgGatewaytemplatePathsValue `cty:"paths" hcl:"paths"`
	Strategy *string                        `cty:"strategy" hcl:"strategy"`
}

type OrgGatewaytemplatePathsValue struct {
...
type OrgGatewaytemplateWanExtraRoutesValue struct {
	Via *string `cty:"via" hcl:"via"`
}

type OrgGatewaytemplateWanExtraRoutes6Value struct {
	Via *string `cty:"via" hcl:"via"`
}
...
type OrgGatewaytemplateRoutingPoliciesValue struct {
	Terms []OrgGatewaytemplateTermsValue `cty:"terms" hcl:"terms"`
}

type OrgGatewaytemplateTermsValue struct {
	Actions                   *OrgGatewaytemplateActionsValue                   `cty:"actions" hcl:"actions"`
	RoutingPolicyTermMatching *OrgGatewaytemplateRoutingPolicyTermMatchingValue `cty:"matching" hcl:"matching"`
}

type OrgGatewaytemplateActionsValue struct {
...
type OrgGatewaytemplateRoutingPolicyTermMatchingValue struct {
	AsPath         []string                            `cty:"as_path" hcl:"as_path"`
	Community      []string                            `cty:"community" hcl:"community"`
	Network        []string                            `cty:"network" hcl:"network"`
	Prefix         []string                            `cty:"prefix" hcl:"prefix"`
	Protocol       []string                            `cty:"protocol" hcl:"protocol"`
	RouteExists    *OrgGatewaytemplateRouteExistsValue `cty:"route_exists" hcl:"route_exists"`
	VpnNeighborMac []string                            `cty:"vpn_neighbor_mac" hcl:"vpn_neighbor_mac"`
	VpnPath        []string                            `cty:"vpn_path" hcl:"vpn_path"`
	VpnPathSla     *OrgGatewaytemplateVpnPathSlaValue  `cty:"vpn_path_sla" hcl:"vpn_path_sla"`
}

type OrgGatewaytemplateRouteExistsValue struct {
	Route   *string `cty:"route" hcl:"route"`
	VrfName *string `cty:"vrf_name" hcl:"vrf_name"`
}

type OrgGatewaytemplateVpnPathSlaValue struct {
...
type OrgGatewaytemplateServicePoliciesValue struct {
	Action          *string                           `cty:"action" hcl:"action"`
	Antivirus       *OrgGatewaytemplateAntivirusValue `cty:"antivirus" hcl:"antivirus"`
	Appqoe          *OrgGatewaytemplateAppqoeValue    `cty:"appqoe" hcl:"appqoe"`
	Ewf             []OrgGatewaytemplateEwfValue      `cty:"ewf" hcl:"ewf"`
	Idp             *OrgGatewaytemplateIdpValue       `cty:"idp" hcl:"idp"`
	...
	Skyatp          *OrgGatewaytemplateSkyatpValue    `cty:"skyatp" hcl:"skyatp"`
	SslProxy        *OrgGatewaytemplateSslProxyValue  `cty:"ssl_proxy" hcl:"ssl_proxy"`
	Syslog          *OrgGatewaytemplateSyslogValue    `cty:"syslog" hcl:"syslog"`
	Tenants         []string                          `cty:"tenants" hcl:"tenants"`
}

type OrgGatewaytemplateAntivirusValue struct {
	AvprofileId *string `cty:"avprofile_id" hcl:"avprofile_id"`
	Enabled     *bool   `cty:"enabled" hcl:"enabled"`
	Profile     *string `cty:"profile" hcl:"profile"`
}

type OrgGatewaytemplateAppqoeValue struct {
	Enabled *bool `cty:"enabled" hcl:"enabled"`
}

type OrgGatewaytemplateEwfValue struct {
...
type OrgGatewaytemplateIdpValue struct {
	AlertOnly    *bool   `cty:"alert_only" hcl:"alert_only"`
	Enabled      *bool   `cty:"enabled" hcl:"enabled"`
...
type OrgGatewaytemplateSyslogValue struct {
	Enabled     *bool    `cty:"enabled" hcl:"enabled"`
	ServerNames []string `cty:"server_names" hcl:"server_names"`
}

type OrgGatewaytemplateTunnelConfigsValue struct {
	AutoProvision  *OrgGatewaytemplateAutoProvisionValue   `cty:"auto_provision" hcl:"auto_provision"`
	IkeLifetime    *int64                                  `cty:"ike_lifetime" hcl:"ike_lifetime"`
	IkeMode        *string                                 `cty:"ike_mode" hcl:"ike_mode"`
	IkeProposals   []OrgGatewaytemplateIkeProposalsValue   `cty:"ike_proposals" hcl:"ike_proposals"`
	IpsecLifetime  *int64                                  `cty:"ipsec_lifetime" hcl:"ipsec_lifetime"`
	IpsecProposals []OrgGatewaytemplateIpsecProposalsValue `cty:"ipsec_proposals" hcl:"ipsec_proposals"`
	...
	Networks       []string                                `cty:"networks" hcl:"networks"`
	Primary        *OrgGatewaytemplatePrimaryValue         `cty:"primary" hcl:"primary"`
	Probe          *OrgGatewaytemplateProbeValue           `cty:"probe" hcl:"probe"`
	Protocol       *string                                 `cty:"protocol" hcl:"protocol"`
	...
	Secondary      *OrgGatewaytemplateSecondaryValue       `cty:"secondary" hcl:"secondary"`
	Version        *string                                 `cty:"version" hcl:"version"`
}

type OrgGatewaytemplateAutoProvisionValue struct {
	AutoProvisionPrimary   *OrgGatewaytemplateAutoProvisionPrimaryValue   `cty:"primary" hcl:"primary"`
	AutoProvisionSecondary *OrgGatewaytemplateAutoProvisionSecondaryValue `cty:"secondary" hcl:"secondary"`
	Enabled                *bool                                          `cty:"enabled" hcl:"enabled"`
	Latlng                 *OrgGatewaytemplateLatlngValue                 `cty:"latlng" hcl:"latlng"`
	Provider               *string                                        `cty:"provider" hcl:"provider"`
	Region                 *string                                        `cty:"region" hcl:"region"`
	ServiceConnection      *string                                        `cty:"service_connection" hcl:"service_connection"`
}

type OrgGatewaytemplateAutoProvisionPrimaryValue struct {
	ProbeIps []string `cty:"probe_ips" hcl:"probe_ips"`
	WanNames []string `cty:"wan_names" hcl:"wan_names"`
}

type OrgGatewaytemplateAutoProvisionSecondaryValue struct {
	ProbeIps []string `cty:"probe_ips" hcl:"probe_ips"`
	WanNames []string `cty:"wan_names" hcl:"wan_names"`
}

type OrgGatewaytemplateLatlngValue struct {
	Lat float64 `cty:"lat" hcl:"lat"`
	Lng float64 `cty:"lng" hcl:"lng"`
}

type OrgGatewaytemplateIkeProposalsValue struct {
...
type OrgGatewaytemplateIpsecProposalsValue struct {
	AuthAlgo *string `cty:"auth_algo" hcl:"auth_algo"`
	DhGroup  *string `cty:"dh_group" hcl:"dh_group"`
	EncAlgo  *string `cty:"enc_algo" hcl:"enc_algo"`
}
...
type OrgGatewaytemplateTunnelProviderOptionsValue struct {
	Jse     *OrgGatewaytemplateJseValue     `cty:"jse" hcl:"jse"`
	Prisma  *OrgGatewaytemplatePrismaValue  `cty:"prisma" hcl:"prisma"`
	Zscaler *OrgGatewaytemplateZscalerValue `cty:"zscaler" hcl:"zscaler"`
}

type OrgGatewaytemplateJseValue struct {
	NumUsers *int64  `cty:"num_users" hcl:"num_users"`
	OrgName  *string `cty:"org_name" hcl:"org_name"`
}

type OrgGatewaytemplatePrismaValue struct {
	ServiceAccountName *string `cty:"service_account_name" hcl:"service_account_name"`
}

type OrgGatewaytemplateZscalerValue struct {
	...
	SubLocations                        []OrgGatewaytemplateSubLocationsValue `cty:"sub_locations" hcl:"sub_locations"`
...
type OrgGatewaytemplateSubLocationsValue struct {
	AupBlockInternetUntilAccepted       *bool    `cty:"aup_block_internet_until_accepted" hcl:"aup_block_internet_until_accepted"`
	AupEnabled                          *bool    `cty:"aup_enabled" hcl:"aup_enabled"`
	AupForceSslInspection               *bool    `cty:"aup_force_ssl_inspection" hcl:"aup_force_ssl_inspection"`
	AupTimeoutInDays                    *int64   `cty:"aup_timeout_in_days" hcl:"aup_timeout_in_days"`
...
type OrgGatewaytemplateVrfConfigValue struct {
	Enabled *bool `cty:"enabled" hcl:"enabled"`
}

type OrgGatewaytemplateVrfInstancesValue struct {
	Networks []string `cty:"networks" hcl:"networks"`
}
