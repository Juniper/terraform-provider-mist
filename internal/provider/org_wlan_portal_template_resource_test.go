...
func (s *OrgWlanPortalTemplateModel) testChecks(t testing.TB, rType, tName string) testChecks {
	...
	if s.PortalTemplate.MarketingPolicyOptIn != nil {
		checks.append(t, "TestCheckResourceAttr", "portal_template.marketing_policy_opt_in", fmt.Sprintf("%t", *s.PortalTemplate.MarketingPolicyOptIn))
	}
	...
	if s.PortalTemplate.MarketingPolicyLink != nil {
		checks.append(t, "TestCheckResourceAttr", "portal_template.marketing_policy_link", *s.PortalTemplate.MarketingPolicyLink)
	}
	if s.PortalTemplate.MarketingPolicyOptInLabel != nil {
		checks.append(t, "TestCheckResourceAttr", "portal_template.marketing_policy_opt_in_label", *s.PortalTemplate.MarketingPolicyOptInLabel)
	}
	if s.PortalTemplate.MarketingPolicyOptInText != nil {
		checks.append(t, "TestCheckResourceAttr", "portal_template.marketing_policy_opt_in_text", *s.PortalTemplate.MarketingPolicyOptInText)
	}
	...
	if s.PortalTemplate.SponsorEmailTemplate != nil {
		checks.append(t, "TestCheckResourceAttr", "portal_template.sponsor_email_template", *s.PortalTemplate.SponsorEmailTemplate)
	}
	...
	if s.PortalTemplate.Locales != nil && len(s.PortalTemplate.Locales) > 0 {
		...
		for locale, localeValue := range s.PortalTemplate.Locales {
			...
			if localeValue.MarketingPolicyLink != nil {
				checks.append(t, "TestCheckResourceAttr", fmt.Sprintf("portal_template.locales.%s.marketing_policy_link", locale), *localeValue.MarketingPolicyLink)
			}
			if localeValue.MarketingPolicyOptIn != nil {
				checks.append(t, "TestCheckResourceAttr", fmt.Sprintf("portal_template.locales.%s.marketing_policy_opt_in", locale), fmt.Sprintf("%t", *localeValue.MarketingPolicyOptIn))
			}
			if localeValue.MarketingPolicyOptInLabel != nil {
				checks.append(t, "TestCheckResourceAttr", fmt.Sprintf("portal_template.locales.%s.marketing_policy_opt_in_label", locale), *localeValue.MarketingPolicyOptInLabel)
			}
			if localeValue.MarketingPolicyOptInText != nil {
				checks.append(t, "TestCheckResourceAttr", fmt.Sprintf("portal_template.locales.%s.marketing_policy_opt_in_text", locale), *localeValue.MarketingPolicyOptInText)
			}
