...
func switchesSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, l []models.EvpnTopologySwitch) basetypes.MapValue {
	...
	for _, d := range l {
		...
		var downlink_ips basetypes.ListValue = types.ListNull(types.StringType)
		var downlinks basetypes.ListValue = types.ListNull(types.StringType)
		var esilaglinks basetypes.ListValue = types.ListNull(types.StringType)
		var evpn_id basetypes.Int64Value
		var mac basetypes.StringValue
		var model basetypes.StringValue
		var pod basetypes.Int64Value
		var pods basetypes.ListValue = types.ListNull(types.Int64Type)
		var role basetypes.StringValue
		var router_id basetypes.StringValue
		var site_id basetypes.StringValue
		var suggested_downlinks basetypes.ListValue = types.ListNull(types.StringType)
		var suggested_esilaglinks basetypes.ListValue = types.ListNull(types.StringType)
		var suggested_uplinks basetypes.ListValue = types.ListNull(types.StringType)
		...
		data_map[data.Mac.ValueString()] = data
	}
