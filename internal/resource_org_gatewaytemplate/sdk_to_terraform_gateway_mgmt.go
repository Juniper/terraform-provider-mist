...
func gatewayMgmtCustomAppsSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, l []models.AppProbingCustomApp) basetypes.ListValue {
	...
	r, e := types.ListValueFrom(ctx, CustomAppsValue{}.Type(ctx), dataList)
	diags.Append(e...)
	return r
}
...
func gatewayMgmtAppProbingSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.AppProbing) basetypes.ObjectValue {
	var apps = types.ListValueMust(types.StringType, []attr.Value{})
	...
	if d != nil {
		...
		if d.CustomApps != nil {
			customApps = gatewayMgmtCustomAppsSdkToTerraform(ctx, diags, d.CustomApps)
		}
		if d.Enabled != nil {
	...
	data, e := NewAppProbingValue(AppProbingValue{}.AttributeTypes(ctx), dataMapValue)
	diags.Append(e...)
	r, e2 := data.ToObjectValue(ctx)
	diags.Append(e2...)
	return r
}
...
func gatewayMgmtAutoSignatureUpdateSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.GatewayMgmtAutoSignatureUpdate) basetypes.ObjectValue {
	...
	data, e := NewAutoSignatureUpdateValue(AutoSignatureUpdateValue{}.AttributeTypes(ctx), dataMapValue)
	diags.Append(e...)
	r, e2 := data.ToObjectValue(ctx)
	diags.Append(e2...)
	return r
...
func gatewayMgmtProtectReCustomSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, l []models.ProtectReCustom) basetypes.ListValue {
	...
	r, e := types.ListValueFrom(ctx, CustomValue{}.Type(ctx), dataList)
	diags.Append(e...)
	return r
}
...
func gatewayMgmtProtectReSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.ProtectRe) basetypes.ObjectValue {
	...
	if d != nil {
		...
		if d.Custom != nil {
			custom = gatewayMgmtProtectReCustomSdkToTerraform(ctx, diags, d.Custom)
		}
		if d.Enabled != nil {
			enabled = types.BoolValue(*d.Enabled)
		}
