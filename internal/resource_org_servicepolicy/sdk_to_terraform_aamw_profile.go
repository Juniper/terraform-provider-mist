...
func aamwSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.ServicePolicyAamw) AamwValue {
	...
	data, e := NewAamwValue(AamwValue{}.AttributeTypes(ctx), dataMapValue)
	diags.Append(e...)
