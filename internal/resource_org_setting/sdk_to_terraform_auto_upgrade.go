...
func autoUpgradeSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.OrgSettingAutoUpgrade) AutoUpgradeValue {
	...
	data, e := NewAutoUpgradeValue(AutoUpgradeValue{}.AttributeTypes(ctx), map[string]attr.Value{
