...
func portalSkToTerraform(ctx context.Context, diags *diag.Diagnostics, d *models.WlanPortal) PortalValue {
	...
	var smsglobalSender basetypes.StringValue
	...
	if d != nil && d.SmsglobalSender != nil {
		smsglobalSender = types.StringValue(*d.SmsglobalSender)
	}
	...
	dataMapValue := map[string]attr.Value{
		...
		"smsglobal_sender":               smsglobalSender,
